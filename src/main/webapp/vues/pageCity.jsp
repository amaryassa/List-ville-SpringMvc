    ...
    <li class="nav-item ">
      ...
      <li class="nav-item ">
    	...
    	<div class="container spacer">
  			<div class="card">
                <div class="card-header bg-primary"> Ville</div>
            <div class="  spacer">
		       ...
		       <div class="card-body">
		          <table class="table table-striped">
		            <thead>
		                <tr>
		                   <th>NOM Ville</th><th>CP</th> <th>Région</th> <th>Langue</th> <th>Pays</th>
		                </tr>
		            </thead>
		            <tbody>
		                 <c:forEach items="${listeCity}" var="city">
		                    <tr>
		                        ...
		                        <td><c:out value="${city.cityArea.areaLabel}"/></td>
		                        <td><c:out value="${city.cityArea.areaLanguage.languageName}"/></td>
		                        <td><c:out value="${city.cityArea.areaCountry.codeIso}"/></td>
		                    </tr>
		                </c:forEach>
		            </tbody>
		            <tfoot> 
