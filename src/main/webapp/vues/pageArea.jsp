    ...
    <li class="nav-item ">
      ...
      <li class="nav-item ">
    	...
    	<div class="container spacer">
  			<div class="card">
                <div class="card-header bg-info"> Région</div>
            <div class="  spacer">
		    	<form:form  method="GET" action="area" >
		    	<div class="input-group col-sm-5">
		          <input name="motCle" type="text" class="form-control " placeholder="Recherche par nom de la région"/>
		       ...
		       <div class="card-body">
		          <table class="table table-striped">
		            <thead>
		                <tr>
		                   <th>NOM</th><th>Langue</th> <th>Pays</th>
		                </tr>
		            </thead>
		            <tbody>
		                <c:forEach items="${listeArea}" var="area">
		                    <tr>
		                        <td><c:out value="${area.areaLabel}"/></td>
		                        <td><c:out value="${area.areaLanguage.languageName}"/></td>
		                        <td><c:out value="${area.areaCountry.codeIso}"/></td>
		                    </tr>
		                </c:forEach>
		            </tbody>
		            <tfoot> 
